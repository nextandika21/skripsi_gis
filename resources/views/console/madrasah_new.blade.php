    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="card">
                ...
                <form action="/console/madrasah" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_madrasah" name="nama_madrasah">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="jenis_madrasah" name="jenis_madrasah">
